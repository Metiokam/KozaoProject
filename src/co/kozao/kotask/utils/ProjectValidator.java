...
public class ProjectValidator {
    ...
    // Valider un projet avant création ou mise à jour
    public static void validate(Project project) throws IllegalArgumentException {
        if (project == null) {
        ...
        validateProjectManager(project.getProjectManager());
    ...
    private static void validateProjectManager(User manager) {
        if (manager == null) {
